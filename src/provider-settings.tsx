...
export function ProviderSettings({
  ...
  async function act(
    ...
    try {
      ...
      if (kind === 'settings' && path !== 'provider/remove') setSaved(true);
    ...
    <section className="settings-card provider-settings">
      <header>
        ...
        {!!connected.length && (
          ...
          >
            <Plus size={15} />
            {expanded || active ? t('收起接入表单') : t('添加或管理连接')}
          </button>
        )}
      </header>
      ...
      <div id={connectID} hidden={!!connected.length && !expanded && !active}>
          ...
          {active && oauth ? (
            ...
            <>
              ...
              {custom ? (
                    ...
                    <div className="provider-form-grid">
                      <label className="field">
                        ...
                        <input
                          ...
                          disabled={disabled}
                          onChange={(e) =>
                            setCustom({ ...custom, context: Number(e.target.value) })
                          }
                        />
                      </label>
                      <label className="field">
                ...
                <div className="provider-form provider-selection-layout">
                        ...
                        {choices.map((p) => (
                          ...
                          >
                            <span>
                              ...
                              {connectionMode === 'oauth' &&
                                p.id === 'openai' &&
                                p.oauth.some((m) => /chatgpt/i.test(m.label)) && (
                                  <small>ChatGPT</small>
                                )}
                            </span>
                            {p.connected ? (
