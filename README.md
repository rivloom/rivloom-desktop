...
后续开发顺序以 [里程碑基线](docs/MILESTONES.md) 为准，详细计划见 [实施计划](docs/plans/2026-08-31-mvp-delivery.md)，当前停点见 [实施进度](docs/PROGRESS.md)，继续开发或开启新会话前读 [交接状态](docs/HANDOFF.md)。M0、M1、M3.1、M3.2 和 M3.3 的 MVP 范围已确认完成；M2 发行完善暂缓；下一会话先讨论并重新定义 M3.4，定义确认前不实现。
