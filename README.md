...
当前正式版为 **0.1.17**，新增同厂商多账号别名、可折叠模型分组和更清晰的系统字体，简化账号接入操作；保留知识库、会话搜索、跨设备协作、审批、成果取回和签名更新。详见 [版本说明](docs/releases/0.1.17.md)，安装包见[官网下载页](https://rivloom.com/download/)。
