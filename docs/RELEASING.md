...
**以下保留 2026-09-09 的方案与当时状态；当前发行结果以本文顶部及 0.1.20 发行验收为准。**
...
当前普通发行见[前述公开同步流程](#普通-rivloom-发行的公开同步)。以下保留当时待实施和验收的签名发行与 updater 流水线要求；不表示当前尚未上线：
