...
R2 桶与下载域名已创建，但长期凭据和 Pages Hook 尚未获授权或接通，桌面与官网的公开下载开关均保持关闭。本决策不声称本次 0.1.4 云端构建、普通 Release 或公开下载已成功；实际结果以 [CI](../CI.md)、[RELEASING](../RELEASING.md) 和维护者本地官网交接记录的对应证据为准。
