...
更新：2026-09-10。源码版本 `0.1.11`，Windows x64 / Rivloom / `com.rivloom.desktop`。0.1.10 已公开发行并完成匿名下载与签名验证；0.1.11 改善消息复制与正文选择，沿用原更新密钥和升级机制，发行以该提交完整 CI 和公开清单核验为准。下方旧候选记录保留为历史资料。
