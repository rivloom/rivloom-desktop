...
更新：2026-09-10。源码版本 `0.1.10`，Windows x64 / Rivloom / `com.rivloom.desktop`。0.1.9 已公开发行且自动清理安装验收通过；0.1.10 增加三类右键菜单，沿用原更新密钥和清理机制，发行以该提交完整 CI 和公开清单核验为准。下方旧候选记录保留为历史资料。
